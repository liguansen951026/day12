...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="typeid" id = "typeid1">
			 ...
			 <div class="form-horizontal m-t">			  
			  <div class="form-group col-lg-7">
                 ...
                 <div class="col-sm-8">
                     <input placeholder="开始时间" id="txt_search_createtime1" name="createtime1" class="laydate-icon form-control layer-date"/>
                     <input placeholder="结束时间"id="txt_search_createtime2" name="createtime2" class="laydate-icon form-control layer-date"/>
                 </div>
	          </div>
		  	</div>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="modal_user_type" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
	...
	Date.prototype.Format = function (fmt) {
	 ...
	 //外部js调用
    laydate({
        elem: '#txt_search_createtime1', //目标元素。由于laydate.js封装了一个轻量级的选择器引擎，因此elem还允许你传入class、tag但必须按照这种方式 '#id .class'
        event: 'focus', //响应事件。如果没有传入event，则按照默认的click
        format: 'YYYY-MM-DD'// 日期格式
    });
    
    laydate({
        elem: '#txt_search_createtime2',
        event: 'focus',
        format: 'YYYY-MM-DD'
    });
